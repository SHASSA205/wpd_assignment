...
public class Planned_road_works_detial extends AppCompatActivity implements ItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planned_road_work_detial);
        ...
        getSupportActionBar().setTitle("Planned Road works");
    ...
    {
        new ApiClient(this).getInstance(this).getWebService().getPlannedworkd().enqueue(new Callback<RoadWorkRssFeed>() {
            @Override
            public void onResponse(Call<RoadWorkRssFeed> call, Response<RoadWorkRssFeed> response) {
                ...
                if(response.body() != null) {
                    ...
                    adapter = new RoadWorkAdapter(getApplicationContext(), response.body(), Planned_road_works_detial.this);
